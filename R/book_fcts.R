...
#' @examples
#' bookfiles_get()
bookfiles_get <- function(path_to_copy = '~/classtools-files') {
  ...
  # data files
  data_path_files <- system.file('extdata/data', package = 'classtools')
  ...
  # scripts
  data_path_files <- system.file('extdata/book-scripts', package = 'classtools')
