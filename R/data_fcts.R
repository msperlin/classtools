...
data_list <- function(be_silent = FALSE) {
  ...
  path_data <- system.file('extdata/data', package = 'classtools')
  ...
  if (!be_silent) {
    ...
    cli::cli_alert_success("Example: df <- classtools::data_import('{sample(my_files, 1)}')")
...
#' Import data from package classtools
#'
